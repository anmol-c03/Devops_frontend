        ...
        stage('Update Playbook') {
            steps {
                sh """
                    ...
                    sed -i 's|image: anizalmuseycai/frontend.*|image: anizalmuseycai/frontend:${BUILD_NUMBER}|g' \$JENKINS_HOME/playbook/deployment.yml
                    sed -i 's|name: anizalmuseycai/frontend.*|name: anizalmuseycai/frontend:${BUILD_NUMBER}|g' \$JENKINS_HOME/playbook/deployment.yml
                """
